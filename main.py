...
# google-generativeai がインストールされていない場合のエラーを防ぐ
try:
    import google.generativeai as genai
except ImportError:
    # Cloud Run環境では requirements.txt からインストールされるので、
    # このエラーは主にローカルでの実行時に発生します。
    print("必要なライブラリがありません。'pip install google-generativeai' を実行してください。")
    genai = None
